          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              {submitted && (
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 flex items-start">
                  ...
                  <p className="text-green-800">
                    {t('Thank you for your message!', 'আপনার বার্তার জন্য ধন্যবাদ!')}
                  </p>
                </div>
              )}
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">{t('Phone', 'ফোন')}</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">{t('Email', 'ইমেইল')}</h3>
                  <a href="mailto:info@dentistbari.com" className="text-blue-600 hover:underline">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">{t('Location', 'অবস্থান')}</h3>
